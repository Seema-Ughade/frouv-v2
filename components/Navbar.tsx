...
export default function Navbar({ isLanding, onToggle }: NavbarProps) {
  return (
    <>
      {/* MOBILE NAVBAR */}
      <div className="xl:hidden flex items-center justify-between px-4 h-16 bg-white dark:bg-[#0a0a0a] shadow-sm">
        {/* Logo Left */}
        ...
        <div className="flex items-center gap-4">
          <Heart className="w-5 h-5 m-2 text-gray-700 dark:text-white" />
          <ShoppingCart className="w-5 h-5 m-2 text-gray-700 dark:text-white" />
          {/* Sidebar */}
          <Sheet>
            ...
            <SheetContent
              side="right"
              className="w-[300px] bg-white dark:bg-gray-900 px-6"
            >
              <div className="flex flex-col h-full">
                ...
                <div className="flex flex-col gap-6 mt-10">
                  <Link
                    href="/"
                    className="w-full h-11 border border-[#78B13F] text-[#78B13F] flex items-center justify-center rounded-full font-semibold hover:bg-[#78B13F] hover:text-white transition"
                  >
                    Become a Seller
                  </Link>
                  <Link
                    href="/"
                    className="w-full h-11 bg-[#78B13F] text-white flex items-center justify-center rounded-full font-semibold hover:bg-[#689f38] transition"
                  >
                    Login / Register
                  </Link>
      ...
      <div className="">
        <div className=" z-50 hidden xl:block bg-white dark:bg-[#0a0a0a] w-full mx-auto h-[92px] px-4 py-2 flex flex-col items-center">
          <div className="max-w-[1440px] w-full h-[76px] flex items-center justify-between">
            <div className="flex items-center xl:ml-10 gap-[38px] w-[609px] h-[76px]">
              <Link
                href="/"
                prefetch={true}
              ...
              <div className="hidden md:flex items-center bg-white border border-gray-200 shadow-sm hover:shadow-md transition rounded-full px-4 py-2 w-[420px]">
                <Input
                  ...
                  className="flex-1 border-0 bg-transparent shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 text-sm text-gray-700 placeholder-gray-400"
                />
                <Button
                  size="icon"
                  className="bg-[#78B13F] hover:bg-[#689f38] p-2 rounded-full ml-2"
                >
              ...
              <div className="relative">
                <div className="flex items-center justify-end gap-[60px] w-[595px] h-[47px]">
                  <div className="flex items-center gap-[60px]">
                    ...
                    <Link
                      href=""
                      className="w-6 h-6 text-gray-700 dark:text-white cursor-pointer relative"
                    >
