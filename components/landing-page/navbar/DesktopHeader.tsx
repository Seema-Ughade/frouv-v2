...
import SearchInputDesktop from "./header/search/search-input-desktop";
...
function DesktopHeader({
  ...
  return (
    <div className="hidden lg:block">
      <div className=" z-50 bg-white w-full mx-auto h-[92px] px-4 py-2 flex flex-col items-center">
        <div className="max-w-[1440px] w-full h-[76px] flex items-center justify-between">
          <div className="flex items-center gap-[38px] w-[609px] h-[76px]">
            ...
            <div className="flex items-center w-[459px] h-12 border border-gray-300 rounded-xl gap-1 pt-[15px] pb-[15px]">
              <SearchInputDesktop />
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-[50px] ml-[59px]">
            <button
              onClick={onToggle}
              className="
      relative w-[132px] h-[45px] rounded-full
      bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50
      border border-[#78B13F]
      flex items-center
      p-1
    ...
    "
        ...
        ${isLanding ? "translate-x-[60px]" : "translate-x-0"}
      `}
              />
        ...
        ${!isLanding ? "text-white" : "text-[#78B13F]"}
      `}
              >
                <FiHome size={18} />
              </span>
      ...
      `}
            ...
            {isRegularUser && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-3 text-gray-700 hover:text-gray-900 font-medium text-[16px]"
              >
                <MapPin className="h-6 text-[#9E9E9E] w-6" />
              ...
              {user ? (
                  ...
                  {isAdmin || isVendor ? (
                    <div className="flex items-center gap-3">
                      <Link
                        ...
                        className="px-4 py-[15px] bg-[#78B13F] hover:bg-[#689f38] hover:text-white leading-none tracking-[0.01em] text-white rounded-[10px] font-inter text-[16px] "
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-[15px] leading-none tracking-[0.01em] font-inter rounded-[10px] border border-[#9E9E9E] text-[16px] font-semibold  text-[#9E9E9E] hover:bg-red-600 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                ...
                <div className="flex items-center justify-end gap-[60px] w-[595px] h-[47px]">
                  <div className="flex items-center gap-[60px]">
                    ...
                    <Link
                      href="/user/login"
                      className="w-6 h-6 text-gray-700 cursor-pointer relative"
                    >
                  ...
                  <div className="flex items-center gap-[42px] w-[449px] h-[47px]">
                    <Link
                      href="/vendor/login"
                      className="w-[193px] gap-2 h-[47px] border border-[#78B13F] text-[#78B13F] flex items-center justify-center rounded-[10px] font-inter font-semibold text-[16px] leading-none tracking-[0.01em] hover:bg-[#689f38] hover:text-white"
                    >
                      <svg
                        width="16"
                        height="16"
                    ...
                    <LoginLink className="w-[193px] gap-1 h-[47px] bg-[#78B13F] flex items-center justify-center text-white rounded-[10px] font-inter font-semibold text-[16px] leading-none tracking-[0.01em] hover:bg-[#689f38]">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
            ...
            {isRegularUser && (
              <>
                <Link
                  ...
                  aria-label="Wishlist"
                  className="text-[#001F1C] mr-8 hover:text-[#9E9E9E] relative"
                >
                  <Heart className="w-6 h-6" />
                  {user && <WishlistBadge />}
                </Link>
                <Link
                  ...
                  aria-label="Cart"
                  className="text-[#001F1C] mr-3 hover:text-[#9E9E9E] relative"
                >
                  <ShoppingCart className="w-6 h-6" />
                  {user && <CartBadge />}
                </Link>
