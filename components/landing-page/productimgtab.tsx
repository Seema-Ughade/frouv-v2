...
export default function ProductImgTab({
  pro,
  variant = 0,
}: {
  pro: Product
...
const imageUrl = rawUrl.startsWith("/")
  ...
  return (
    <div className="group relative p-2 w-full sm:max-w-[260px] bg-gradient-to-r from-red-50 to-blue-50 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
      {/* Image Section */}
